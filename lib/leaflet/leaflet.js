...
*/
		...
		siteOpenIoD			= siteProtocol + 'openiod.org/SCAPE604';
...
*/			
        ...
        openBasisKaartLayer = L.tileLayer.wms(siteProtocol+"www.openbasiskaart.nl/mapcache?SRS=EPSG%3A28992", {  
			layers: 'osm',
            format: 'image/png',
            transparent: true,
			tiled: true,
...
//===========================================================================  end of constructor
	...
	var secureSite;
	var siteProtocol, siteAireas, siteOpenIoD;
...
*/
				...
				if (valueRounded == 0) {
					...
					fillOpacity = 0.5 + (valueRounded%2)/10;  // domainGroups ; //0.8;
				}
...
/*	
	function initLayerGpx(options) {
		var gpx = siteOpenIoD+'/openiod?SERVICE=WPS&REQUEST=Execute&identifier=observation_gpx&featureofinterest=marathonEHV'; // URL to your GPX file or the GPX itself
//		ajaxGetData(siteAireas + "/data/aireas/getGPX/marathon/*", 
//			function(data) {
//				//var _data = JSON.parse(data);
//			}
//		);		
		new L.GPX(gpx, {async: true,
  			marker_options: {
    			startIconUrl: '../client/apri-client-leaflet/images/pin-icon-start.png',
    			endIconUrl: '../client/apri-client-leaflet/images/pin-icon-end.png',
    			shadowUrl: '../client/apri-client-leaflet/images/pin-shadow.png'
  			}
