...
//					document.getElementById('popup-x' + properties.cell_x + '-y' + properties.cell_y).remove();
	...
	function initLayerGpx(options) {
		var gpx = 'http://localhost:4000/SCAPE604/openiod?SERVICE=WPS&REQUEST=Execute&identifier=observation_gpx&featureofinterest=marathonEHV'; // URL to your GPX file or the GPX itself
